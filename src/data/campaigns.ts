...
export const campaigns: Campaign[] = [
  {
    ...
    description:
      `${monthJP}の出張買取・宅配買取を対象に、エルメス・シャネル・ロレックスをはじめとした主要ブランドの買取額を通常より引き上げてお見積もりします。ご利用のタイミングがお決まりでしたら、ぜひお声がけください。`,
    bullets: [
      `対象期間：${monthRangeJP}`,
  ...
  },
  {
    ...
    ctaTarget: "line",
    note: "LINE特典の併用条件は、出張買取・宅配買取いずれの買取方法でも同条件で適用されます。",
  },
  {
    id: "referral",
    badge: "ご紹介",
  ...
  },
  {
    ...
    badge: "おまとめ",
    title: "おまとめ査定で買取額UP",
    subtitle: "複数点・まとめてお持ち込みで段階的に上乗せ",
    description:
      "ブランドバッグ・時計・ジュエリー・財布・アパレルなど、複数点をまとめて査定にお出しいただいたお客様には、合計買取金額に応じて段階的に買取額を上乗せします。相続・形見整理・断捨離でまとまった点数をお持ちのお客様に特に喜ばれているプランです。",
    bullets: [
      "3点以上のお持ち込み・宅配で +3% UP",
      "5点以上で +5% UP",
      "10点以上で +10% UP（事前見積もり推奨）",
      "出張買取・宅配買取・店頭ご持ち込みすべて適用",
      "他キャンペーン（ブランド別UP・LINE特典）との併用可（同一品の重複適用は不可）",
    ],
    ctaLabel: "まとめて査定を依頼する",
    ctaTarget: "form",
    note: "おまとめ対象は買取成立した品の合計点数で判定します。査定後にキャンセルされた品は対象点数から除外されます。",
  },
];
